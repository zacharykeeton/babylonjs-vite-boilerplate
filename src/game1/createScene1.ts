...
var createScene1 = function (
    ...
    var box = BABYLON.MeshBuilder.CreateBox("box", { height: 1.25 }, scene);
    ...
    var button1 = Button.CreateSimpleButton("but1", "Go to scene 2");
    button1.width = "150px";
    button1.height = "40px";
    button1.color = "white";
    ...
    button1.onPointerUpObservable.add(function () {
        // alert("need to go to scene2!");
        console.log("scene1 button clicked");

        setActiveScene(Scenes.SCENE2);
    });
